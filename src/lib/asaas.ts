...
export async function sendPixTransfer(params: PixTransferParams): Promise<AsaasTransferResult> {
    const apiKey = process.env.ASAAS_API_KEY || "$aact_prod_000MzkwODA2MWY2OGM3MWRlMDU2NWM3MzJlNzZmNGZhZGY6OjI2Yjc5Yjc2LTMyM2MtNGQ4Yi05NTA2LWNhYTIzMzRhYWVlNTo6JGFhY2hfMGRiOWQ5NDEtY2U1Mi00MTQ1LWFkNDYtNzM4NGIyODI3Y2Iz"
