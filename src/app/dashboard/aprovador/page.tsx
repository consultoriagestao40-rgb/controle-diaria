...
export default function ApproverDashboard() {
    ...
    const filteredItems = useMemo(() => {
        ...
        return items.filter(item => {
            const matchesSearch = (
                ...
                (item.empresa?.nome && item.empresa.nome.toLowerCase().includes(term))
            )
    ...
    }, [items, searchTerm, selectedEmpresa, startDate, endDate])
    ...
    return (
        <div className="space-y-4 md:space-y-6 pb-24 md:pb-32 px-1 md:px-0">
            ...
            <div className="space-y-2 md:space-y-3">
                ...
                {(searchTerm || startDate || endDate || groupBy !== 'NONE' || selectedEmpresa !== 'ALL') && (
            ...
            <Dialog open={!!selectedItem || !!batchItemsToApprove} onOpenChange={(open) => {
                ...
                <DialogContent className="max-w-md rounded-2xl border-none shadow-2xl bg-white">
                    <DialogHeader>
