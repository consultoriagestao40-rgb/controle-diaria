...
export async function GET(req: NextRequest) {
    ...
    if (user.role !== 'ADMIN' && user.role !== 'FINANCEIRO' && user.role !== 'RH' && user.role !== 'APROVADOR_N1' && user.role !== 'APROVADOR_N2' && user.role !== 'APROVADOR') return new NextResponse("Forbidden", { status: 403 })
