        ...
        <div className="space-y-8 max-w-6xl mx-auto pb-16">
            ...
            <div className="space-y-3">
                ...
                <div className="flex gap-4 sm:gap-6 overflow-x-auto py-2 scrollbar-hide shrink-0 snap-x">
                    ...
                    {acessoDespesas && (
                        <>
                            <Link href="/dashboard/despesas/nova" className="flex flex-col items-center gap-2 group snap-center shrink-0">
                                ...
                                <span className="text-[10px] font-bold text-slate-500 group-hover:text-slate-900 transition-colors uppercase tracking-wider w-16 text-center leading-tight">Nova Despesa</span>
                            </Link>

                            <Link href="/dashboard/despesas" className="flex flex-col items-center gap-2 group snap-center shrink-0">
                                <div className="h-14 w-14 rounded-full bg-slate-100 hover:bg-indigo-50 border border-slate-200/50 hover:border-indigo-200 flex items-center justify-center text-slate-700 hover:text-indigo-600 shadow-md group-active:scale-95 transition-all duration-300">
                    ...
                    {acessoCoberturas && (
                        <>
                            <Link href="/dashboard/supervisor/nova" className="flex flex-col items-center gap-2 group snap-center shrink-0">
                                <div className="h-14 w-14 rounded-full bg-slate-100 hover:bg-indigo-50 border border-slate-200/50 hover:border-indigo-200 flex items-center justify-center text-slate-700 hover:text-indigo-600 shadow-md group-active:scale-95 transition-all duration-300">
                            ...
                            <Link href="/dashboard/supervisor" className="flex flex-col items-center gap-2 group snap-center shrink-0">
                                <div className="h-14 w-14 rounded-full bg-slate-100 hover:bg-indigo-50 border border-slate-200/50 hover:border-indigo-200 flex items-center justify-center text-slate-700 hover:text-indigo-600 shadow-md group-active:scale-95 transition-all duration-300">
                    ...
                    {user.role === 'ADMIN' && (
                        <Link href="/dashboard/despesas/admin/centros-custo" className="flex flex-col items-center gap-2 group snap-center shrink-0">
                            <div className="h-14 w-14 rounded-full bg-slate-100 hover:bg-indigo-50 border border-slate-200/50 hover:border-indigo-200 flex items-center justify-center text-slate-700 hover:text-indigo-600 shadow-md group-active:scale-95 transition-all duration-300">
